...
Asserts the new opt-in wiring in ``shorewall_nft.daemon.core``: when
...
from shorewall_nft.daemon import core as core_mod
from shorewall_nft.daemon.core import Daemon
...
def test_daemon_without_allowlist_does_not_build_pipeline(
    ...
    async def run():
        ...
        async def wrapped_run():
            ...
            import shorewall_nft.daemon.core as mod
            monkeypatch.setattr(
...
def test_daemon_with_allowlist_builds_pipeline(
    ...
    async def run():
        ...
        from shorewall_nft.daemon import worker_router
        monkeypatch.setattr(
