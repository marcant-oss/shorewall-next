...
from shorewall_nft.daemon.proto import peer_pb2
...
class TestHmacAuth:
    ...
    def test_short_secret_rejected(self):
        from shorewall_nft.daemon.peer import HmacSha256Auth
...
class TestSnapshotRequestResponse:
    ...
    def test_snapshot_round_trip_applies_entries(
        ...
        from shorewall_nft.daemon.dns_set_tracker import Proposal, Verdict
    ...
    def test_snapshot_chunking_across_many_entries(
        ...
        from shorewall_nft.daemon.dns_set_tracker import Proposal, Verdict
        from shorewall_nft.daemon.peer import SNAPSHOT_CHUNK_SIZE
...
class TestPeerIsUp:
    def test_fresh_heartbeat_is_up(self):
        ...
        from shorewall_nft.daemon.peer import PeerMetrics
        m = PeerMetrics()
